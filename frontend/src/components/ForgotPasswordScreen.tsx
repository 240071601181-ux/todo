...
import { Mail, ArrowLeft, ShieldAlert, CheckCircle, Cpu } from 'lucide-react'

interface ForgotPasswordScreenProps {
  onSubmit: (email: string) => Promise<void>
}

export default function ForgotPasswordScreen({ onSubmit }: ForgotPasswordScreenProps) {
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-xs mt-1 font-mono">
            Recover your workspace credentials
          </p>
        </div>
